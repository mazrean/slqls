...
![test](https://github.com/mazrean/slqls/workflows/test/badge.svg)
...
![code_actions](https://github.com/mazrean/slqls.vim/blob/master/imgs/sqls_vim_demo.gif)
...
```shell
go install github.com/mazrean/slqls@latest
```

## Editor Plugins

- [sqls.vim](https://github.com/mazrean/slqls.vim)
...
<a href="https://github.com/mazrean/slqls/graphs/contributors">
